 ...
 */
public class TrustStorePropertyJsonDeserializationTest {

    public static final String JSON_CERTIFICATE = "-----BEGIN CERTIFICATE-----\\r\\n" +
    ...
    @Test
    public void should_deserialize_json_keystore() throws Exception {
        String json = "{\"certificates\":[\""+JSON_CERTIFICATE+"\",\""+JSON_CERTIFICATE+"\"]}";

        System.out.println(json);
        ObjectMapper mapper = new ObjectMapper();
        final TrustStoreProperty actual = mapper.readValue(json, TrustStoreProperty.class);

        final ArrayList<Certificate> certificates = new ArrayList<>();
        certificates.add(new CertificateFactory().newInstance(CERTIFICATE));
        certificates.add(new CertificateFactory().newInstance(CERTIFICATE));
        TrustStoreProperty expected = new TrustStoreProperty(certificates);
