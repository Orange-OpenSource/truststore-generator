...
/**
 * Created by sbortolussi on 29/10/2015.
 */
public class TrustStorePropertyTest {
   ...
   @Test(expected = IllegalArgumentException.class)
    public void keystore_should_have_a_least_one_certificate(){
        final List<Certificate> certificates = new ArrayList<>();
        new TrustStoreProperty(certificates);
    }
}